...
namespace lilToon.URP.Extensions.PostProcessing
{
    ...
    {
        private void ApplyApertureBokehLayer(CommandBuffer cmd, RenderTextureDescriptor sourceDescriptor, RTHandle source, RTHandle destination, ImageProcessRuntimeLayer runtimeLayer)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref apertureBokehTextureA, bokehDescriptor, FilterMode.Bilinear, TextureWrapMode.Clamp, name: "_lilImageProcessApertureBokehA");
            RenderingUtils.ReAllocateIfNeeded(ref apertureBokehTextureB, bokehDescriptor, FilterMode.Bilinear, TextureWrapMode.Clamp, name: "_lilImageProcessApertureBokehB");
            ...
            cmd.SetGlobalTexture(ImageProcessShaderConstants.BloomTexId, apertureBokehTextureA);
            ...
            int layerIndex)
        {
            ...
            bokehDesc.name = $"_lilImageProcessApertureBokeh_{layerIndex}";
            ...
            bokehDesc.name = $"_lilImageProcessApertureBokehTmp_{layerIndex}";
