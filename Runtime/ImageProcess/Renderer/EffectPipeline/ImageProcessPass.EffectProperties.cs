...
namespace lilToon.URP.Extensions.PostProcessing
{
    ...
    {
        private static void ApplyLayerProperties(ImageProcessLayer layer, Material material)
        {
            LayerPropertyBlock properties = LayerPropertyBlock.FromLayer(layer);
            ApplyEffectPropertyDefaults(layer.effect, ref properties);

            material.SetFloat(ImageProcessShaderConstants.IntensityId, layer.intensity);
            material.SetFloat(ImageProcessShaderConstants.SharpnessId, properties.Sharpness);
            material.SetFloat(ImageProcessShaderConstants.ModeId, layer.parameters0.x);
            material.SetFloat(ImageProcessShaderConstants.AngleId, layer.parameters0.z * Mathf.Deg2Rad);
            material.SetFloat(ImageProcessShaderConstants.LayerBlendModeId, (float)layer.blendMode);

            material.SetColor(ImageProcessShaderConstants.LayerColorId, properties.Color);
            material.SetFloat(ImageProcessShaderConstants.LayerTextureEnabledId, layer.texture != null ? 1.0f : 0.0f);
            material.SetVector(ImageProcessShaderConstants.LayerParams0Id, properties.Params0);
            material.SetVector(ImageProcessShaderConstants.LayerParams1Id, properties.Params1);
            material.SetVector(ImageProcessShaderConstants.LayerParams2Id, properties.Params2);
            material.SetVector(ImageProcessShaderConstants.LayerParams3Id, properties.Params3);
            material.SetVector(ImageProcessShaderConstants.LayerParams4Id, properties.Params4);
            material.SetVector(ImageProcessShaderConstants.LayerParams5Id, properties.Params5);
            material.SetVector(ImageProcessShaderConstants.LayerParams6Id, properties.Params6);
            material.SetVector(ImageProcessShaderConstants.LayerParams7Id, properties.Params7);
            material.SetVector(ImageProcessShaderConstants.LayerParams8Id, properties.Params8);
            material.SetVector(ImageProcessShaderConstants.LayerParams9Id, properties.Params9);
            material.SetVector(ImageProcessShaderConstants.LayerParams10Id, properties.Params10);
            material.SetVector(ImageProcessShaderConstants.LayerParams11Id, properties.Params11);
            material.SetVector(ImageProcessShaderConstants.LayerParams12Id, properties.Params12);
            if (layer.texture != null)
            {
                material.SetTexture(ImageProcessShaderConstants.LayerTextureId, layer.texture);
            }

            material.SetVector(
                ImageProcessShaderConstants.LogoTextureEnabled0Id,
                new Vector4(
            ...
            material.SetVector(
                ImageProcessShaderConstants.LogoTextureEnabled1Id,
                new Vector4(
        ...
        private struct LayerPropertyBlock
        {
            ...
            public static LayerPropertyBlock FromLayer(ImageProcessLayer layer)
            {
