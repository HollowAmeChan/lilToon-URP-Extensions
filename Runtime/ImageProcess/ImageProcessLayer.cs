...
{
    [Serializable]
    public sealed class ImageProcessLayer
    {
        ...
        [Tooltip("这个图层对应的 ImageProcess 效果。Custom Material 会直接使用材质或 Shader 覆盖。")]
        public ImageProcessEffect effect = ImageProcessEffect.CustomMaterial;
        ...
        public ImageProcessBlendMode blendMode = ImageProcessBlendMode.Normal;
