...
{
    internal static class ImageProcessShaderConstants
    {
        public const string DefaultLayerShaderName = "Hidden/lilToon/URP/ImageProcess/PostProcessLayerBlit";
        public const string TempTextureAName = "_lilImageProcessTempA";
        public const string TempTextureBName = "_lilImageProcessTempB";
