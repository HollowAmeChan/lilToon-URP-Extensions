Shader "Hidden/lilToon-Shoost/URP/Shoost/ApertureBokeh"
{
    SubShader
    {
        Tags
        ...
        Pass
        {
            Name "Shoost Aperture Bokeh Prefilter"
        ...
        Pass
        {
            Name "Shoost Aperture Bokeh Blur"
        ...
        Pass
        {
            Name "Shoost Aperture Bokeh Post Filter"
        ...
        Pass
        {
            Name "Shoost Aperture Bokeh Composite"
