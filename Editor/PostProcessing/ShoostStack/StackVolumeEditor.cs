...
namespace lilToon.URP.Extensions.Editor.PostProcessing
{
    ...
    internal sealed partial class ShoostPostProcessStackVolumeEditor : VolumeComponentEditor
    {
        ...
        private static readonly EffectToggleEntry[] VisibleEffectOrder =
        {
            ...
            new EffectToggleEntry(ShoostPostProcessEffect.SkyGodRays, "天空神光", "icon_Flare_Ray_v1"),
        ...
        private void DrawElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (GetEffect(element) == ShoostPostProcessEffect.PrismFracture)
            {
            ...
            if (GetEffect(element) == ShoostPostProcessEffect.SkyGodRays)
            {
