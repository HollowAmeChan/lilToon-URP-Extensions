...
namespace lilToon.URP.Extensions.Editor.PostProcessing
{
    internal sealed partial class ImageProcessStackVolumeEditor
    {
        ...
        private static Texture2D LoadCrtEffectsTexture(int index)
        {
            ...
            {
                case 1:
                    name = "ImageProcessCRTScanlinesRGBMono";
                    break;
                case 2:
                    name = "ImageProcessCRTScanlinesCircle";
                    break;
                case 3:
                    name = "ImageProcessCRTScanlinesLine";
                    break;
                default:
                    name = "ImageProcessCRTScanlinesRGB";
                    break;
            }

            return AssetDatabase.LoadAssetAtPath<Texture2D>($"{PackageAssetRoot}/Runtime/ImageProcess/Textures/{name}.png");
        }
    }
}
